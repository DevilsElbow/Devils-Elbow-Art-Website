...
<?php 
$query = "SELECT items.item_id, items.description, items.detail, items.sale_price, artists.first_name, artists.last_name, items.image FROM items
...
foreach($result as $row) {
	...
	<p>Artist: <?php echo $row['first_name'] . " " . $row['last_name'];?></p>
